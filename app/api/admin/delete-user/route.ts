// C:\Users\KOGARPC\Proyectos\plataforma-escolar-cfv\app\api\admin\delete-user\route.ts
...
export async function POST(req: Request) {
  ...
  if (!body.userId) return NextResponse.json({ error: 'Falta userId' }, { status: 400 })

  // Evitar que un admin se borre a sí mismo por accidente
  if (body.userId === gate.adminId) {
